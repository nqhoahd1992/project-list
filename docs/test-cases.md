...
| B-12 | Currency được Market gợi ý nhưng vẫn sửa được | — | Chọn Market lần lượt AU/MY/SG/VN → xem dropdown Currency; sau đó đổi Currency sang GBP rồi Submit | Mỗi lần đổi Market, Currency tự nhảy về gợi ý tương ứng AUD/MYR/SGD/VND; người dùng chọn tay giá trị khác (AUD/USD/GBP/MYR/SGD/VND/CNY) thì CR lưu đúng giá trị đã chọn, **không** bị Market ghi đè lúc Submit | Trung bình |
